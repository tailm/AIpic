...
INSTALL_DIR="$HOME"
CLONE_DIR="AIpic"
# Use Python 3.13 which is already installed on the system
...
check_system_requirements() {
    ...
    if command_exists "$PYTHON_CMD"; then
        ...
        print_warning "Python 3.13 not found. Will install it from deadsnakes PPA"
    fi
...
install_system_dependencies() {
    ...
    # For Python 3.13, we need to add deadsnakes PPA
